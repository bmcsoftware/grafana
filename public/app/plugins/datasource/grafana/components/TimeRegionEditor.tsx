...
const daysNameTranslated = () => { return ([t('bmcgrafana.grafana-ui.weekdays.monday', 'Monday'), t('bmcgrafana.grafana-ui.weekdays.tuesday', 'Tuesday'), t('bmcgrafana.grafana-ui.weekdays.wednesday', 'Wednesday'), t('bmcgrafana.grafana-ui.weekdays.thursday', 'Thursday'), t('bmcgrafana.grafana-ui.weekdays.friday', 'Friday'), t('bmcgrafana.grafana-ui.weekdays.saturday', 'Saturday'), t('bmcgrafana.grafana-ui.weekdays.sunday', 'Sunday')]) };
const days = () => {
...
export const TimeRegionEditor = ({ value, onChange }: Props) => {
  ...
  const renderTimezonePicker = () => {
    ...
    if (isDashboardTimezone) {
      return <><Trans i18nKey={'bmcgrafana.time-region-editor.dashboard-timezone'}>Dashboard timezone</Trans> ({timezone})</>;
    }
