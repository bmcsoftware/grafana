...
export class OrgCustomConfiguration extends PureComponent<Props, State> {
  ...
  validateURL = (value: any) => value.length === 0 || RegExp(/^(http|https):\/\/[^ "]+$/).test(value) || 'Invalid URL!';
  ...
  render() {
    ...
    return (
      <>
        <Field label="Documentation" invalid={!!errors.docLink} error={errors.docLink && errors.docLink.message}>
          <Input
            type="text"
            value={docLink}
            {...register('docLink', {
        ...
        <Field label="Support" invalid={!!errors.supportLink} error={errors.supportLink && errors.supportLink.message}>
          <Input
            type="text"
            value={supportLink}
        ...
        <Field label="Video" invalid={!!errors.videoLink} error={errors.videoLink && errors.videoLink.message}>
          <Input
            type="text"
            value={videoLink}
            {...register('videoLink', {
