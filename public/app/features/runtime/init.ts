        ...
        autoTable(doc, {
          ...
          willDrawCell: function (data: any) {
            ...
            if (data.cell.section === 'head' && data.cell.raw.nodeName === 'TH') {
              ...
              doc.setFillColor(theme.tableHeaderFillColor);
            } else {
              doc.setFont(fontFamily, 'normal');
              doc.setFillColor(theme.fillColor);
            }

            let showHyperLink = false;
            ...
            if (data.cell.raw && data.cell.raw.nodeName === 'TH'
              ...
              showHyperLink = true;
              // Cell text width should be less then the column width otherwise for longer text cursor will
              // be displayed to next column whereas the text is wrapped to the next line.
              let width = data.cell.contentWidth < data.column.width ? data.cell.contentWidth : data.column.width;
              doc.link(data.cell.x, data.cell.y, width, data.cell.contentHeight, {
                url: data.cell.raw.firstChild.href,
              });
            }
            ...
            if (!showHyperLink && data.cell.section === 'body' && data.cell.raw && data.cell.raw.firstChild 
              && data.cell.raw.firstChild.lastChild instanceof HTMLAnchorElement
              && data.cell.raw.firstChild.lastChild.href) {
              showHyperLink = true;
              let width = data.cell.contentWidth < data.column.width ? data.cell.contentWidth : data.column.width;
              doc.link(data.cell.x, data.cell.y, width, data.cell.contentHeight, {
                url: data.cell.raw.firstChild.lastChild.href,
              });
            }
            doc.setTextColor(showHyperLink ? theme.hyperLinkColor : theme.textColor);
          },
        });
