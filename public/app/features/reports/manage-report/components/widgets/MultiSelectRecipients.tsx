...
import { InputActionMeta } from '@grafana/ui/node_modules/@types/react-select';
        ...
        render={({}) => {
          return (
            <MultiSelect
              ...
              onChange={(values: ReportRecipientItem[]) => {
                onSelect(values);
                return values;
              }}
              filterOption={onFilterChange}
              onInputChange={(query: string, meta: InputActionMeta) => {
