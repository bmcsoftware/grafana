...
function CollapseLabel(): ReactElement {
  ...
  return (
    ...
    <h5>
      <Trans i18nKey="bmcgrafana.dashboards.settings.variables.variables-tab.variables-unknown-table.title">Renamed or missing variables</Trans>
      <Tooltip content={t('bmcgrafana.dashboards.settings.variables.variables-tab.variables-unknown-table.info-circle-description','Click to expand a list with all variable references that have been renamed or are missing from the dashboard.')}>
...
// BMC Change: To enable localization for below text
 function NoUnknowns(): ReactElement {
  return <span><Trans i18nKey="bmcgrafana.dashboards.settings.variables.variables-tab.variables-unknown-table.decription">No renamed or missing variables found.</Trans></span>;
}
