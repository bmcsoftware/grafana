...
describe('type guards', () => {
  ...
  const variableFactsObj: Record<VariableType | ExtraVariableTypes, VariableFacts> = {
    ...
    datepicker: { variable: createDatePickerVariable(), isMulti: false, hasOptions: false, hasCurrent: true },
    optimizepicker: { variable: createOptimizeVariable(), isMulti: false, hasOptions: false, hasCurrent: true },
  };
