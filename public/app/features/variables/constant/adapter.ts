...
export const createConstantVariableAdapter = (): VariableAdapter<ConstantVariableModel> => {
  return {
    id: 'constant',
    description: t('bmcgrafana.dashboards.settings.variables.editor.select-variable-type.constant.description','Define a hidden constant variable, useful for metric prefixes in dashboards you want to share.'),
