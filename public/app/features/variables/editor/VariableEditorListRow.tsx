          ...
          <td role="gridcell" className={styles.column}>
            <div className={styles.icons}>
              ...
              <IconButton
                ...
                name="copy"
                tooltip={t('bmcgrafana.dashboards.settings.variables.variables-tab.variable-editor-list-row.copy-title','Duplicate variable')}
              ...
              <IconButton
                ...
                // BMC Change: To enable localization for below text
                name="trash-alt"
                tooltip={t('bmcgrafana.dashboards.settings.variables.variables-tab.variable-editor-list-row.trash-alt-title','Remove variable')}
...
function VariableCheckIndicator({ passed }: VariableCheckIndicatorProps): ReactElement {
  ...
  return (
    ...
    <Icon
      ...
      title={t('bmcgrafana.dashboards.settings.variables.variables-tab.variable-editor-list-row.exclamation-triangle-title','This variable is not referenced by any variable or dashboard.')}
    />
  );
}
