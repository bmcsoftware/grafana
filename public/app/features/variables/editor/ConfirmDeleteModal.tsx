...
export function ConfirmDeleteModal({ varName, isOpen = false, onConfirm, onDismiss }: Props) {
  return (
    <ConfirmModal
      title={t('bmcgrafana.dashboards.settings.variables.variables-tab.delete.delete-variable-title','Delete variable')}
      isOpen={isOpen}
      onConfirm={onConfirm}
      onDismiss={onDismiss}
      body={t('bmcgrafana.dashboards.settings.variables.variables-tab.delete.body',
