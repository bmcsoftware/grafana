...
export const _request = <T>(url: string, data?: string | object | null, options?: RequestOptions): Observable<FetchResponse<T>> => {
...
export const getVariables = (): VariablesMap => {
  ...
  return getTemplateSrv().getVariables().reduce((variablesMap: VariablesMap, variable: any) => {
