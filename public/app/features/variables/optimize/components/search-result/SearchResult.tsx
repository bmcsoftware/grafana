  ...
  return (
    <>
      <VerticalGroup className={props.containerClassName} width={props.width}>
        <div data-testid="domain-picker-close-search-panel" onClick={() => props.onClose()} style={styles.closeIconContainer}>
        ...
        <div style={styles.mainContainer}>
          <div style={styles.allItemsContainer}>
            ...
            { (props.resultItems?.length > 0) && <div style={styles.pagination}>
              <Pagination
