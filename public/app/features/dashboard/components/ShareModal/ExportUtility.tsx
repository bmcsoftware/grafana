...
const defaultReportTypeOptions: Array<SelectableValue<ReportType>> = [
  ...
  { label: 'XLSX', value: ReportType.XLS, fileType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileExt: 'xlsx' },
...
const ExportUtility: React.FC<Props> = (props) => {
  ...
  const isTablePanel = props.panel?.type === 'table' || props.panel?.type === 'table-old' || props.panel?.type === 'bmc-ade-cross-tab';
    ...
    <div className="share-modal-body">
      <div className="share-modal-header">
        ...
        <div className="share-modal-content">
          ...
          {
            shouldShowLayout && (<div className="gf-form">
          ...
          {
            shouldShowOrientation && (<div className="gf-form">
