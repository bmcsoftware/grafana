...
export function getNavTitle(navId: string | undefined) {
  ...
  switch (navId) {
    ...
    case 'roles':
      return t('nav.teams.title', 'Roles');
    case 'plugins':
...
export function getNavSubTitle(navId: string | undefined) {
  switch (navId) {
    ...
    // BMC code - next case
    case 'roles':
      return t('nav.roles.subtitle', 'Manage roles across an organization');
    case 'plugins':
    ...
    case 'apikeys':
      return t('nav.api-keys.subtitle', 'Manage and create API keys that are used to interact with BMC Helix Dashboards HTTP APIs');
    case 'serviceaccounts':
      return t('nav.service-accounts.subtitle', 'Use service accounts to run automated workloads in BMC Helix Dashboards');
    case 'global-users':
