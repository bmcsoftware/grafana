...
import { AppEvents, FeatureState, SelectableValue } from '@grafana/data';
    ...
    if (type !== 'admin') {
      if (checked) {
        ...
        if (newEnabledTypes.length === 1) {
          appEvents.emit(AppEvents.alertWarning, ['At least one query type should be enabled']);
          return;
        }
            ...
            <FieldSet label={<Trans i18nKey="shared-preferences.title">Preferences</Trans>} disabled={disabled}>
              ...
              {this.props.resourceUri === 'org' ? (
                <>
                  <Label>
                    <span className={styles.labelText}>
                      <Trans i18nKey="shared-preferences.fields.enabled-query-types">
