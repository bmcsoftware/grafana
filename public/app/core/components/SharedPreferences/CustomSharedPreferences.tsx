...
export const CustomDateFormatPicker: FC<CustomDateFormatPickerProps> = ({ value, onChange, resourceUri }) => {
  ...
  const options: SelectableValue[] = [
    ...
    { label: 'Datetime FR', description: 'DD/MM/YYYY HH:mm:ss', value: 'DD/MM/YYYY HH:mm:ss' },
    ...
    { label: 'Datetime UK', description: 'DD/MM/YYYY HH:mm:ss', value: 'DD/MM/YYYY HH:mm:ss' },
  ...
  const description = () => {
    let labelDescription = `${t(
      'shared-preferences.datetime-format.description',
      ...
      label={
        <Label htmlFor="datetime-format" description={description()}>
          <span className={styles.labelText}>
            <Trans i18nKey="shared-preferences.datetime-format.label">Datetime Format</Trans>
          </span>
        </Label>
      }
