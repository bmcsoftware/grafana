...
export class CalcFieldsSrv {
  ...
  getSortOptions() {
    ...
    const sortDescriptionAsc = t('bmc.calc-fields.sort-asc-descripton','Sort results in an alphabetically ascending order');
    const sortDescriptionDsc = t('bmc.calc-fields.sort-dsc-descripton','Sort results in an alphabetically descending order');
