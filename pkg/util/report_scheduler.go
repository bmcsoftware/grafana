...
func Params(req *http.Request, name string) string {
	return web.Params(req)[name]
}

func ParamsInt64(req *http.Request, name string) (int64, error) {
	return strconv.ParseInt(Params(req, name), 10, 64)
}

func ParamsBool(req *http.Request, name string) (bool, error) {
	return strconv.ParseBool(Params(req, name))
}
