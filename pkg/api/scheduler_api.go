...
func (hs *HTTPServer) registerSchedulerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/reports/settings/branding", func(branding routing.RouteRegister) {
			branding.Get("/", routing.Wrap(hs.GetReportBrandingSettings))
			branding.Post("/", reqOrgAdmin, routing.Wrap(hs.SetReportBrandingSettings))
			branding.Delete("/", reqOrgAdmin, routing.Wrap(hs.DeleteReportBrandingSettings))
		})
