...
func (hs *HTTPServer) GetAllCalcFields(c *models.ReqContext) response.Response {
...
func (hs *HTTPServer) CreateNewCalcFields(c *models.ReqContext) response.Response {
...
func (hs *HTTPServer) DeleteCalcFieldsById(c *models.ReqContext) response.Response {
...
func (hs *HTTPServer) ModifyCalcFieldsById(c *models.ReqContext) response.Response {
