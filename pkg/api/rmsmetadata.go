...
func (hs *HTTPServer) GetViewDetails(c *contextmodel.ReqContext) response.Response {
	...
	// Temp debug log
	hs.log.Debug("Path to rms service to get view details", path, headers, queryParams)
...
func (hs *HTTPServer) GetGeneratedQuery(c *contextmodel.ReqContext) response.Response {
	...
	// Temp debug log
	hs.log.Debug("Path to rms service to generate sql", path, headers, queryParams)
