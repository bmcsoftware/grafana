...
func GetRSById(c *models.ReqContext) response.Response {
	...
	data, err := SelectById(query)
	if err != nil {
		return FailResponse(err)
	}
	return SuccessResponse(reportToJson(data))
}
func GetRSByDashIds(c *models.ReqContext, cmd dtos.ListRS) response.Response {
	if len(cmd.Ids) == 0 {
		return GetRS(c)
	}
	...
	data, err := SelectByDashIds(query)
	if err != nil {
		return FailResponse(err)
	}
	result := make([]*dtos.RSData, 0)
...
func InsertRS(c *models.ReqContext, cmd dtos.InsertRS) response.Response {
	if err := checkReportLimitReached(c.OrgId); err != nil {
		return FailResponse(err)
	}
...
func UpdateRS(c *models.ReqContext, cmd dtos.UpdateRS) response.Response {
...
func DeleteRS(c *models.ReqContext, cmd dtos.ListRS) response.Response {
...
func DeleteRSByDashIds(c *models.ReqContext, cmd dtos.ListRS) response.Response {
...
func EnableRS(c *models.ReqContext, cmd dtos.ListRS) response.Response {
...
func DisableRS(c *models.ReqContext, cmd dtos.ListRS) response.Response {
...
func ReportPDFPreview(c *models.ReqContext, cmd dtos.RSDataPreview) response.Response {
...
func ReportSendMail(c *models.ReqContext, cmd dtos.RSDataSendMail) response.Response {
	// Sanitize fields
	cmd.Name = util.SanitizeHtml(cmd.Name)
	cmd.Description = util.SanitizeHtml(cmd.Description)
...
func ReportExecuteOnce(c *models.ReqContext, cmd dtos.ListRS) response.Response {
	if len(cmd.Ids) == 0 {
	...
	result, err := SelectJobById(query)
	if err != nil {
		return response.Error(500, err.Error(), err)
	}
...
func GetTenantUsers(c *models.ReqContext) response.Response {
	result := getTenantUsers(c.OrgId, c.Query("query"), c.QueryInt("limit"))
	return response.JSON(200, result)
}

// -------------- Queries Dispatchers to SQLStore -------------- //
func SelectAll(query *models.GetAll) ([]*models.RSData, error) {
	if err := bus.Dispatch(query); err != nil {
		return nil, err
	}
	return query.Result, nil
}
func SelectById(query *models.GetById) (*models.RSData, error) {
	if err := bus.Dispatch(query); err != nil {
		return nil, err
	}
	return query.Result, nil
...
func SelectByDashIds(query *models.GetByDashIds) ([]*models.RSData, error) {
	if err := bus.Dispatch(query); err != nil {
		return nil, err
	}
	return query.Result, nil
...
func SelectJobById(query *models.GetJobById) (*models.ExecuteRS, error) {
	if err := bus.Dispatch(query); err != nil {
		return nil, err
	}
	return query.Result, nil
...
func InsertRSJobQueue(c *models.ReqContext, cmd dtos.RSJobQueue) response.Response {
...
func UpdateRSJobQueue(c *models.ReqContext, cmd dtos.RSJobQueue) response.Response {
...
func InsertRSJobStatus(c *models.ReqContext, cmd dtos.RSJobStatus) response.Response {
...
func RemoveOrDisableOrgSchedules(c *models.ReqContext) response.Response {
	...
	isOffboarded, err := strconv.ParseBool(c.Query("isOffboarded"))
	if err != nil {
		return FailResponse(err)
	}
...
func GetReportTenantDetails(c *models.ReqContext) response.Response {
	result, err := getReportTenant(c.OrgId)
	if err != nil {
		return FailResponse(err)
	}
	return SuccessResponse(result)
...
func CreateOrUpdateReportTenantDetails(c *models.ReqContext, cmd dtos.ReportTenantDetails) response.Response {
	if err := setReportTenantDetails(c.OrgId, cmd); err != nil {
		return FailResponse(err)
	}
...
func getReportTenant(orgId int64) (*dtos.ReportTenantDetails, error) {
...
func getReportCountByTenantId(orgId int64) (*int64, error) {
...
func setReportTenantDetails(orgId int64, reportDetails dtos.ReportTenantDetails) error {
...
func checkReportLimitReached(orgId int64) error {
	var err error
	...
	// Get tenant details
	if reportTenantDetails, err = getReportTenant(orgId); err != nil {
		...
		if err = setReportTenantDetails(orgId, *reportTenantDetails); err != nil {
			return err
		}
	}

	// Get report count for current user tenant
	if reportCount, err = getReportCountByTenantId(orgId); err != nil {
		return err
	}
