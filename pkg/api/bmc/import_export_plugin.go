...
func (p *PluginsAPI) ExportPlugin(c *models.ReqContext) response.Response {
	...
	for _, dash := range dashboards {
		...
		dsList := p.prepareDatasource(c.Req.Context(), dash, datasources)
...
func (p *PluginsAPI) prepareDatasource(c context.Context, dashboard *models.Dashboard, inputs map[string]*simplejson.Json) []*simplejson.Json {
