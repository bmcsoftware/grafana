...
func (hs *HTTPServer) getTenantUsers(ctx context.Context, orgID int64, query string, limit int) []*models.OrgUserDTO {
	...
	if err := hs.SQLStore.GetOrgUsers(ctx, grafanaQuery); err != nil {
