...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/teams", func(teamsRoute routing.RouteRegister) {
			...
			teamsRoute.Get("/search", authorize(reqSignedIn, ac.EvalPermission(ac.ActionTeamsRead)), routing.ConditionedWrap(mspSvc.SearchTeams, hs.SearchTeams, func(c *models.ReqContext) bool {
				return c.SignedInUser.HasExternalOrg
			}), reqSignedIn)
		})
