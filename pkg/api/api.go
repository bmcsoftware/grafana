...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/datasources", func(datasourceRoute routing.RouteRegister) {
			...
			datasourceRoute.Get("/:id", authorize(reqGrafanaAdmin, ac.EvalPermission(ActionDatasourcesRead, ScopeDatasourceID)), routing.Wrap(GetDataSourceById))
			datasourceRoute.Get("/uid/:uid", authorize(reqGrafanaAdmin, ac.EvalPermission(ActionDatasourcesRead, ScopeDatasourceUID)), routing.Wrap(GetDataSourceByUID))
			datasourceRoute.Get("/name/:name", authorize(reqGrafanaAdmin, ac.EvalPermission(ActionDatasourcesRead, ScopeDatasourceName)), routing.Wrap(GetDataSourceByName))
		})
