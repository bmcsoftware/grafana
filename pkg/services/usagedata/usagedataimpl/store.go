...
type store interface {
	...
	GetUserDataService(ctx context.Context, orgID int64) (usagedata.UserCountResponse, error)
...
// surghosh change
func (ss *sqlStore) GetUserDataService(ctx context.Context, orgID int64) (usagedata.UserCountResponse, error) {
