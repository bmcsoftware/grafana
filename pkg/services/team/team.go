...
type Service interface {
	...
	CreateTeam(name, email string, orgID int64, Id int64, teamType int, IsMspTeams ...bool) (Team, error)
	...
	// BMC code - next line
	CustomAddTeamMember(ctx context.Context, cmd *AddTeamMemberCommand) error
