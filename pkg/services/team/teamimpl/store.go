...
type store interface {
	...
	Create(name, email string, orgID int64, Id int64, IsMspTeams ...bool) (team.Team, error)
...
func (ss *xormStore) Create(name, email string, orgID int64, Id int64, isMspTeams ...bool) (team.Team, error) {
	t := team.Team{
		ID:      Id,
		Name:    name,
		Email:   email,
