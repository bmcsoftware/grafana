...
func init() {
	bus.AddHandler("sql", GetReportSettings)
	bus.AddHandler("sql", SetReportSettings)
	bus.AddHandler("sql", DeleteReportSettings)
}

func GetReportSettings(query *models.GetReportBranding) error {
...
func SetReportSettings(query *models.SetReportBranding) error {
...
func DeleteReportSettings(query *models.DeleteReportBranding) error {
	return inTransaction(func(sess *DBSession) error {
