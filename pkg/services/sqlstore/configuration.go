...
func init() {
	bus.AddHandler("sql", GetCustomConfiguration)
	bus.AddHandler("sql", SetCustomConfiguration)
	bus.AddHandler("sql", ResetCustomConfiguration)
}

func GetCustomConfiguration(query *models.GetCustomConfiguration) error {
...
func SetCustomConfiguration(query *models.SetCustomConfiguration) error {
...
func ResetCustomConfiguration(query *models.RefreshCustomConfiguration) error {
	return inTransaction(func(sess *DBSession) error {
